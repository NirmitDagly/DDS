...
open class FillableLoader: UIView, CAAnimationDelegate {
    ...
    open var duration: TimeInterval = 8.0
    ...
    internal func initialSetup(on view: UIView? = nil) {
        ...
        loaderView.frame = CGRect(x: view!.bounds.origin.x, y: view!.bounds.origin.y, width: view!.frame.width, height: rectSize)
        loaderView.center = CGPoint(x: 60, y: 60)
    ...
    internal func defaultValues() {
        ...
        loaderColor = UIColor(red: 0.29, green: 0.325, blue: 0.647, alpha: 1.0)
